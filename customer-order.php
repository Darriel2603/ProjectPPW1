                ...
                <div class="user-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            $statement = $pdo->prepare("SELECT * FROM payment WHERE customer_email=? ORDER BY id DESC");
                            ...
                            $statement = $pdo->prepare("SELECT * FROM payment WHERE customer_email=? ORDER BY id DESC LIMIT $start, $limit");
                            $statement->execute(array($_SESSION['customer']['cust_email']));
