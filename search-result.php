...
<div class="page">
    <div class="container">
        <div class="row">
			...
			<?php
            $adjacents = 5;
            $statement = $pdo->prepare("SELECT * FROM product WHERE p_is_active=? AND p_name LIKE ?");
            ...
            $statement = $pdo->prepare("SELECT * FROM product WHERE p_is_active=? AND p_name LIKE ? LIMIT $start, $limit");
            $statement->execute(array(1,$search_text));
